            ...
            <div className='flex flex-col items-center justify-center space-y-4 bg-custom-lighter-blue font-roboto'>
                ...
                <div className='flex flex-col items-center justify-center p-6'>
                    ...
                    <div className='flex flex-col items-center justify-center space-y-4'>
                        ...
                        <h1 className='text-2xl'>of serious medical errors involve miscommunication during handoffs between healthcare providers</h1>
                    </div>
                </div>
                <div className='flex flex-col items-center justify-center p-6'>
                    ...
                    <div className='flex flex-col items-center justify-center space-y-4'>
                        ...
                        <h1 className='text-2xl'>look-alike/sound-alike drug names labeled by the Institute for Safe Medication Practices (ISMP)</h1>
                    </div>
                </div>
                <div className='flex flex-col items-center justify-center p-6'>
                    ...
                    <div className='flex flex-col items-center justify-center space-y-4'>
                        ...
                        <h1 className='text-2xl'>of medical students struggle with medical terminology, often due to pronunciation difficulties</h1>
                    </div>
                </div>
                </div>
            </div>
