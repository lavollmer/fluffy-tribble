...
const about = () => {
  return (
    <>
      <div className='flex flex-col items-center justify-center pt-20 font-roboto'>
        <div className='flex flex-col items-center justify-center space-y-4 pb-0'>
          <h1 className='font-bold text-4xl'>About the Software Developer and Founder</h1>
          <h2 className='font-bold text-2xl'>AI-Led MedPronunciation</h2>
        </div>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 p-4'>
          <div className='flex flex-col items-center justify-center'>
            <img src={AboutImg} alt="AboutImg" className='w-full h-full p-20' />
          </div>
